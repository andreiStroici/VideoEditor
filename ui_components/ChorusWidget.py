...
class ChorusWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        top_row = QHBoxLayout()
        self.enable_cb = QCheckBox("Enable Chorus")
        ...
        self.delay_spin.setRange(20, 100) 
        self.delay_spin.setValue(40)
        ...
        self.depth_spin.valueChanged.connect(lambda: self.value_changed.emit())
    ...
    def set_data(self, data):
        ...
        self.delay_spin.setValue(int(data.get('Delay', 40)))
        self.depth_spin.setValue(float(data.get('Depth', 0.3)))
