...
class EchoWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        top_row = QHBoxLayout()
        self.enable_cb = QCheckBox("Enable Echo")
        ...
        self.decay_spin.setValue(0.6)
        self.decay_spin.valueChanged.connect(lambda: self.value_changed.emit())
        ...
        form.addRow("Decay:", self.decay_spin)
        form.addRow("Mix:", self.mix_spin)
        
        group = QGroupBox("Echo (Audio)")
    ...
    def set_data(self, data):
        ...
        self.decay_spin.setValue(float(data.get('Decay', 0.6)))
